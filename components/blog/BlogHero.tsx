export default function BlogHero() {
  return (
    <section className="relative py-20 sm:py-32 bg-dark overflow-hidden">
      {/* Grid Background */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(240,196,69,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(240,196,69,0.05)_1px,transparent_1px)] bg-[size:40px_40px]" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold text-white mb-4 tracking-tighter">
          DIGITAL <span className="text-slate-500">JOURNAL</span>
        </h1>
