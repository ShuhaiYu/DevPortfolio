    ...
    <section className="py-24 bg-dark border-t border-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div key={t.id} className="relative bg-surface p-8 border-l-2 border-slate-800 hover:border-accent transition-colors duration-300 group">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs font-mono text-primary">{t.role} @ {t.company}</div>
                </div>
              </div>
