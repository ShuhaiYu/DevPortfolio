        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="relative">
              <Zap className={`relative h-6 w-6 ${scrolled ? 'text-primary' : 'text-white'} transition-colors group-hover:text-accent`} />
            </div>
            {!scrolled && (
               <span className="ml-2 font-heading font-bold text-lg sm:text-xl tracking-tighter text-white group-hover:text-primary transition-colors">{OWNER_NAME}</span>
            )}
          </div>
