      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
           <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="font-mono text-xs text-slate-300 uppercase tracking-widest">System Capabilities</span>
           </div>
           <h2 className="text-5xl md:text-6xl font-heading font-bold text-white mb-6">
             ACTIVE <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">PROTOCOLS</span>
           </h2>
